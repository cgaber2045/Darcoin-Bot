...
function dailyIncome() {
  ...
  allwallets.forEach((amt, userId) => {
    ...
    try {
      ...
      console.log("User not found - possibly banned: " + userId);
    } 
  })
}
...
module.exports = {help, createRoles, dailyIncome, hire, fire, listJobs, hasJob}