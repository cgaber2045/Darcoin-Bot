...
// Function to ban a user (not tested enough)
  ...
  if (guild.member(user) != null) {
    if (guild.member(user).bannable) {
      guild.member(user).send("You have been banned by " + wallet.getNickFromID(message.author.id) + ".").then(
        ...
        bot.channels.cache.get(defaultConfig.generalChannelID).send(wallet.getNickFromID(message.author.id) + " has gunned " + wallet.getNickFromID(user) + " down.");
      return true;
    } else {
  ...
  if (guild.member(user) != null) {
    if (guild.member(user).voice.channel) {
      if (guild.member(user).bannable) {
        ...
        //bot.channels.cache.get(defaultConfig.generalChannelID).send(wallet.getNickFromID(message.author.id) + " has deafened " + wallet.getNickFromID(user) + ".");
        return true;
      } else {
  ...
  if (guild.member(user) != null) {
    if (guild.member(user).voice.channel) {
      if (guild.member(user).bannable) {
        ...
        bot.channels.cache.get(defaultConfig.generalChannelID).send(wallet.getNickFromID(message.author.id) + " has undeafened " + wallet.getNickFromID(user) + ".");
        return true;
      } else {
  ...
  if (guild.member(user) != null) {
    if (guild.member(user).voice.channel) {
      if (guild.member(user).bannable) {
        ...
        //guild.member(user).send("You have been deafened by " + wallet.getNickFromID(message.author.id) + ".");
        //bot.channels.cache.get(defaultConfig.generalChannelID).send(wallet.getNickFromID(message.author.id) + " has gagged " + wallet.getNickFromID(user) + ".");
        return true;
      } else {
  ...
  if (guild.member(user) != null) {
    if (guild.member(user).voice.channel) {
      if (guild.member(user).bannable) {
        ...
        bot.channels.cache.get(defaultConfig.generalChannelID).send(wallet.getNickFromID(message.author.id) + " has ungagged " + wallet.getNickFromID(user) + ".");
        return true;
      } else {
